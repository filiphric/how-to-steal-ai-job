...
<img src="/karpathy.png" class="w-70% left-30 -bottom-18 absolute z-1" />

<Block class="absolute right-10 bottom-7 bg-white p-4">
<img src="/qr_karpathy.png" class="h-20 mt-2">
...
<img src="/job-postings.png" class="h-85 mx-auto">
</Block>
...
<img src="/zuck.png" class="h-110 mx-auto  -bottom-5 right-2 rotate-1">

<Block class="absolute right-10 bottom-7 bg-white p-4">
<img src="/qr_galloway.png" class="h-20 mt-2">
<span class="text-xs text-center mx-auto block">source</span>
</Block>
...
::left::
<img src="/farhan.png" class="relative bottom-25 left-20" />
<Block class="absolute left-25 bottom-7 bg-white p-2 z-1">
  <img src="/qr_farhan.png" class="h-20 mt-2">
<span class="text-xs text-center mx-auto block">youtube link</span>
</Block>

::right::
<img src="/angie_jones.png" class="w-75% relative bottom-20 left-10" />
<Block class="absolute right-25 bottom-5 bg-white p-2 z-1">
  <img src="/qr_angie.png" class="h-20 mt-2">
<span class="text-xs text-center mx-auto block">youtube link</span>
</Block>
...
<img src=/highlight-reel-effect.png />
</Block>
...
<img src="/gandalf_lvl1.png" />
</Block>


<Block class="absolute right-15 bottom-7 bg-white p-2 z-1">
  <img src="/qr_gandalf.png" class="h-20 mt-2">
...
sequenceDiagram
    participant USER
    participant HARMLESSNESS
    participant INPUT VALIDATION
    participant A.I.
    participant HANDLE RESPONSES

    USER->>HARMLESSNESS: Submits Input
    HARMLESSNESS->>INPUT VALIDATION: Forwards Harmless Input
    INPUT VALIDATION->>A.I.: Forwards Validated Input
    A.I.-->>HANDLE RESPONSES: Generates Response
    HANDLE RESPONSES-->>USER: Delivers Final Response
```

<Block class="absolute right-16 top-7 bg-white p-2 z-1">
  <img src="/qr_anthropic.png" class="h-20 mt-2">
...
<Block class="absolute right-15 bottom-13 bg-white p-2 z-1">
  <img src="/qr_nolima.png" class="h-20 mt-2">
<span class="text-xs text-center mx-auto block">source</span>
</Block>
...
<Block class="absolute right-15 bottom-7 bg-white p-2 z-1">
  <img src="/qr_context_engineering.png" class="h-20 mt-2">
<span class="text-xs text-center mx-auto block">source</span>
</Block>
...
<Block class="w-60% px-2 bg-white absolute top-5 right-55">
  <img src="/context_engineering_part_3.png" />
</Block>
